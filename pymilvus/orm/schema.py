...
type Highlighter = Union[LexicalHighlighter]

class LexicalHighlighter:
    def __init__(self, *,queries: Optional[List] = None, highlight_search_text: Optional[bool] = None, pre_tags: Optional[List[str]] = None, post_tags: Optional[List[str]] = None, fragment_offset: Optional[int] = None, fragment_size: Optional[int] = None, num_of_fragments: Optional[int] = None):
    ...
    def with_query(self, field: str, text: str, type: str):
        if self.queries is None:
            self.queries = []
        self.queries.append({"type": type, "field": field, "text": text})
